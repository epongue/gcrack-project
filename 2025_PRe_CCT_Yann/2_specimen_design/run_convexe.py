...
class GCrackData(GCrackBase):
    def generate_mesh(self, crack_points: List[np.ndarray]) -> gmsh.model:
        ...
        # Lines
        # Bot
        lb1: int = gmsh.model.geo.addCircleArc(p1, c2, p3)
        ...
        lb4: int = gmsh.model.geo.addCircleArc(p4, c1, p2)
        lb5: int = gmsh.model.geo.addLine(p2, p1)
        # Top
        lt1: int = gmsh.model.geo.addCircleArc(p5, c2, p3)
        ...
        lt4: int = gmsh.model.geo.addCircleArc(p4, c1, p6)
